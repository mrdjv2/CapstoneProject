...
```{r, cache=TRUE}
blogs_sample<-sample(blogs, length(blogs)*0.1, replace = FALSE)
news_sample<-sample(news, length(news)*0.1, replace = FALSE)
twitter_sample<-sample(twitter, length(twitter)*0.1, replace = FALSE)
